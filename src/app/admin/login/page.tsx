...
export default function AdminLoginPage() {
  ...
  console.log('AdminLoginPage - Renderizando página de login do admin');
        ...
        <div className="bg-white rounded-2xl shadow-2xl p-8">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full bg-red-600 text-white py-3 px-4 rounded-lg font-semibold hover:bg-red-700 disabled:bg-red-400 disabled:cursor-not-allowed transition-colors flex items-center justify-center"
            >
              {isLoading ? (
                <>
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-yellow-700 mt-1">
                  Este é um acesso administrativo. Todas as ações são registradas e monitoradas.
                </p>
              </div>
            </div>
          </div>
